  ...
  ru: {
    translation: {
      ...
      catalog: {
        ...
        mockHint:
          'Без Firebase в .env показан учебный каталог-заглушка. Заполните EXPO_PUBLIC_FIREBASE_* для данных из облака.',
        onDevice: 'На устройстве (SQLite)',
        searchPlaceholder: 'Поиск по названию и описанию…',
        categoryAll: 'Все',
        catBasics: 'Основы',
        catConcurrency: 'Конкурентность',
        catHttp: 'HTTP',
      ...
      notifications: {
        newCourseTitle: 'Новый курс в каталоге',
        newCourseBody: '{{title}}',
        catalogReminderTitle: 'Проверь каталог',
        catalogReminderBody: 'Открой приложение и посмотри новые материалы.',
      },
    },
  },
  en: {
    translation: {
      ...
      catalog: {
        ...
        mockHint:
          'Firebase env vars are missing, so the built-in demo catalog is shown. Set EXPO_PUBLIC_FIREBASE_* for cloud data.',
        onDevice: 'On device (SQLite)',
      ...
      courseScreen_noTests:
        'This course has no tests — it is a local record (lab 1) or content without the tests field.',
      ...
      notifications: {
        newCourseTitle: 'New course in the catalog',
        newCourseBody: '{{title}}',
        catalogReminderTitle: 'Check the catalog',
        catalogReminderBody: 'Open the app and see what is new.',
      },
    },
  },
} as const;
